...
itf:
  - image_path: /assets/images/ITF-2026-logo.jpg
    ...
    title: "International Thespian Festival Registration"
    excerpt: >-
...
{% include feature_row type="left" id="spongebob" %}
{% include feature_row type="left" id="itf" %}

Want to support extracurricular activities at Willows? Donate to the Willows Prep Family Association!  
  
[Donate Now!](https://willowsprepfamily.org){: .btn .btn--primary}
